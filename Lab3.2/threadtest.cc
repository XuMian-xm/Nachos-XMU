...
#define TABLESIZE 10
#define BOUNDEDBUFFERSIZE 100
// testnum is set in main.cc
int testnum = 1;
int T=2;
int N=2;
int p_size = 1;//生产者一次生产的大小
int c_size = 10;//消费者一次消费的大小
int producersnum=2;
int consumersnum=2;
...
{
	int num = 0;//the number of the items you want to insert
	while (true)
	{
		 void *item;
		 int key=Random()%10;
...
ThreadTest2()
{
	...
	list = new DLList(); bool flag = false;
	if (flag) {
